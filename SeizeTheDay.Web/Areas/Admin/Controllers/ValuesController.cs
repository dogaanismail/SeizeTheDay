...
//    {
//        private readonly RoleManager<AppRole> roleManager = new RoleManager<AppRole>(new Microsoft.AspNet.Identity.EntityFramework.RoleStore<Roles>(new IdentityContext()));
