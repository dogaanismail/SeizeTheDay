    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var model = new IndexViewModel
            {
                ...
                BrowserRemembered = await AuthenticationManager.TwoFactorBrowserRememberedAsync("55")
            };
            return View(model);
        }
        #endregion

        #region PasswordProcesses
