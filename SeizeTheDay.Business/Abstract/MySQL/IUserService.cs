...
namespace SeizeTheDay.Business.Abstract.MySQL
{
    ...
    {      
        ...
        User GetUserMessenger(string id);
        ...
        List<User> StringIncludeWithExpression(string id, params string[] children);
        List<User> StringIncludeWithoutExpression();

        User SingleStringIncludeWithExp(string id, params string[] children);
        User SingleStringIncludeWithoutExpression( params string[] children);
